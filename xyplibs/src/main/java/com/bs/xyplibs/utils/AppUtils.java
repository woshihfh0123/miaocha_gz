...
public class AppUtils {
    ...
    public static boolean isInstallApp(Context context, String packageName) {
        return !Utils.isSpace(packageName) && IntentUtils.getLaunchAppIntent(context, packageName) != null;
    }
    ...
    public static boolean installAppSilent(String filePath) {
        ...
        ShellUtils.CommandResult commandResult = ShellUtils.execCmd(command, !isSystemApp(BaseApp.getInstance()), true);
