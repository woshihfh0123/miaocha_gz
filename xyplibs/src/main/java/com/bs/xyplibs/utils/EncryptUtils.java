...
import static com.bs.xyplibs.utils.ConvertUtils.bytes2HexString;
import static com.bs.xyplibs.utils.ConvertUtils.hexString2Bytes;
...
public class EncryptUtils {
    ...
    public static void decoderBase64File(String base64Code,String savePath) throws Exception {
       //需要去掉字符串的data:image/png;base64,如果没有去掉可以使用split(",")[1]
        // byte[] bitmapArray = Base64.decode(string.split(",")[1], Base64.DEFAULT);
