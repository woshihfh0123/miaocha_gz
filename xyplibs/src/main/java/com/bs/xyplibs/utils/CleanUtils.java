...
public class CleanUtils {
    ...
    public static boolean cleanInternalCache() {
        return FileUtils.deleteFilesInDir(BaseApp.getInstance().getCacheDir());
    }
    ...
    public static boolean cleanInternalFiles() {
        return FileUtils.deleteFilesInDir(BaseApp.getInstance().getFilesDir());
    }
    ...
    public static boolean cleanInternalDbs() {
        return FileUtils.deleteFilesInDir(BaseApp.getInstance().getFilesDir().getParent() + File.separator + "databases");
    }
    ...
    public static boolean cleanInternalDbByName( String dbName) {
        return BaseApp.getInstance().deleteDatabase(dbName);
    }
    ...
    public static boolean cleanInternalSP() {
        return FileUtils.deleteFilesInDir(BaseApp.getInstance().getFilesDir().getParent() + File.separator + "shared_prefs");
    }
    ...
    public static boolean cleanExternalCache() {
        return SDCardUtils.isSDCardEnable() && FileUtils.deleteFilesInDir(BaseApp.getInstance().getExternalCacheDir());
    }
