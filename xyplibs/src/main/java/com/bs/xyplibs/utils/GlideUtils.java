...
import com.bs.xyplibs.view.MyImageView;
...
public class GlideUtils {
    ...
    //    public static final int placeholderSoWhite = R.color.cp_color_gray;
//    public static final int errorSoWhite = R.color.cp_color_gray;
    public static final int placeholderSoWhite = R.drawable.base_photo_def;
    public static final int errorSoWhite = R.drawable.base_photo_def;
    ...
    public static void loadImage(Context context, String url, ImageView imageView,int error) {
        if(Utils.isNotEmpty(url)&&url.contains("http")){
            if(url.contains("https")){
                url=url.replace("https","http");
            }
    ...
    public static void loadImage(Context context, String url, MyImageView imageView,int error) {
    ...
    public static void loadImageCircle(Context context, String url, MyImageView imageView,int error) {
    ...
    public static void loadImageHome(Context context, String url, ImageView imageView) {
        if(Utils.isNotEmpty(url)&&url.contains("http")){
            if(url.contains("https")){
                url=url.replace("https","http");
            }
    ...
    public static void loadBannerImage(Context context, String url, ImageView imageView) {
        if(Utils.isNotEmpty(url)&&url.contains("http")){
            ...
            RequestOptions options = new RequestOptions()
                    ...
                    .error(R.drawable.no_banner)       //错误图
                    .diskCacheStrategy(DiskCacheStrategy.ALL);
            Glide.with(context).load(url).apply(options).into(imageView);
        }
     ...
     *加载图片(默认)
     */
    public static void loadImage(Context context, String url, MyImageView imageView) {
        if(Utils.isNotEmpty(url)&&url.contains("http")){
            if(url.contains("https")){
                url=url.replace("https","http");
            }
...
//            Glide.with(context).load(url).apply(options).into(imageView);
    ...
    public static void loadImage(Context context, Drawable url, MyImageView imageView) {
    ...
    public static void loadImage(Context context, Uri url, MyImageView imageView) {
        if(Utils.isNotEmpty(url)){
...
//            Glide.with(context).load(url).apply(options).into(imageView);
     ...
     * @param imageView
     */
    public static void loadImageSize(Context context, String url, ImageView imageView,int width) {
        if(Utils.isNotEmpty(url)&&url.contains("http")) {
            if (url.contains("https")) {
                url = url.replace("https", "http");
            }
