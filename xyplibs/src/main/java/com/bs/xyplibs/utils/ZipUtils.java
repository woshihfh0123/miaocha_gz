...
import static com.bs.xyplibs.utils.ConstUtils.KB;
...
public class ZipUtils {
    ...
    private static boolean zipFile(File resFile, String rootPath, ZipOutputStream zos, String comment)
        ...
        if (resFile.isDirectory()) {
            ...
            if (fileList == null || fileList.length <= 0) {
                ...
                if (!Utils.isEmpty(comment)) entry.setComment(comment);
    ...
    public static List<File> unzipFileByKeyword(File zipFile, File destDir, String keyword)
        ...
        while (entries.hasMoreElements()) {
            ...
            if (Utils.isEmpty(keyword) || FileUtils.getFileName(entryName).toLowerCase().contains(keyword.toLowerCase())) {
