 ...
 * 1、在建立项目的过程中，首先配置初始默认的dimens.xml文件，
 * 2、其余的尺寸先不用管。项目的所有配置结束后，在DimenTool.java类中，
 * 3、右键Run DimenTool.main执行这段代码，就可以在指定的个路径dimens.xml文件中按照事先设置好的比例参数，生成对应的适配。
 *
 */
...
//        File file = new File("./app/src/main/res/values/dimens.xml");
        File file = new File("./xyplibs/src/main/res/values/dimens.xml");
        ...
        try {
            ...
            String sw240file = "./xyplibs/src/main/res/values-sw240dp-land/dimens.xml";

            String sw480file = "./xyplibs/src/main/res/values-sw480dp-land/dimens.xml";

            String sw600file = "./xyplibs/src/main/res/values-sw600dp-land/dimens.xml";

            String sw720file = "./xyplibs/src/main/res/values-sw720dp-land/dimens.xml";

            String sw800file = "./xyplibs/src/main/res/values-sw800dp-land/dimens.xml";

            String w820file = "./xyplibs/src/main/res/values-w820dp/dimens.xml";
