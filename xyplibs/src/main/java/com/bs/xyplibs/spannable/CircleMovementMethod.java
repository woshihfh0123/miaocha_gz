package com.bs.xyplibs.spannable;
...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = BaseApp.getInstance().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = BaseApp.getInstance().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
