...
import com.bs.xyplibs.bean.PhotoInfo;
import com.bs.xyplibs.spannable.ColorFilterImageView;
import com.bs.xyplibs.utils.GlideUtils;
...
public class MultiImageView extends LinearLayout {
	...
	private ImageView createImageView(int position, final boolean isMultiImage) {
		...
		GlideUtils.loadImage(getContext(),photoInfo.url,imageView);
