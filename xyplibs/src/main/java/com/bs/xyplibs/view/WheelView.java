...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xFF393838;

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xFFb6b5b5;
	...
	private void initResourcesIfNecessary() {
		...
		setBackgroundResource(R.drawable.wheel_bg_new);
	}
