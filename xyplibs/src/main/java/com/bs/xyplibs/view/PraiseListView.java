...
import com.bs.xyplibs.bean.FavortItem;
import com.bs.xyplibs.bean.TabTwoBean;
import com.bs.xyplibs.spannable.CircleMovementMethod;
import com.bs.xyplibs.spannable.SpannableClickable;
...
public class PraiseListView extends TextView{
    ...
    private List<TabTwoBean.DataBean.ListBean.PraiseListBean> datas;
    ...
    public List<TabTwoBean.DataBean.ListBean.PraiseListBean> getDatas() {
        return datas;
    }
    public void setDatas(List<TabTwoBean.DataBean.ListBean.PraiseListBean> datas) {
        this.datas = datas;
    ...
    public void notifyDataSetChanged(){
        ...
        if(datas != null && datas.size() > 0){
            ...
            TabTwoBean.DataBean.ListBean.PraiseListBean item = null;
    ...
    private SpannableString setImageSpan(){
        ...
        imgSpanText.setSpan(new ImageSpan(BaseApp.getInstance(), R.drawable.dzz, DynamicDrawableSpan.ALIGN_BASELINE),
