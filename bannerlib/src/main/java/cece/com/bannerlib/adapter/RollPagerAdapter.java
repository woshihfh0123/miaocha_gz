...
public class RollPagerAdapter extends MyPagerAdapter {
    ...
    private List<PicBean> bannerList;

    public RollPagerAdapter(Context context, boolean isCirMode, List<PicBean> bannerList) {
        super(context);
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (onItemViewClickListener != null) {
                        onItemViewClickListener.onItemClick(view, bannerList.get(finalPosition));
                    }
                }
            });
            return view;
