...
public class TCMusicManager {
    ...
    public void loadMusicList() {
        ...
        TCHttpURLClient.getInstance().get("http://miaocha.yanshi.hbbeisheng.com/api/public/appapi/?service=Music.hotLists", new TCHttpURLClient.OnHttpCallback() {
//        TCHttpURLClient.getInstance().get(UGCKitConstants.SVR_BGM_GET_URL, new TCHttpURLClient.OnHttpCallback() {
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    JSONArray list = bgmObject.getJSONArray("info");
                    ...
                    for(int i=0;i<bgmInfoList.size();i++){
                        bgmInfoList.get(i).setName(bgmInfoList.get(i).getTitle());
                        bgmInfoList.get(i).setLocalPath(bgmInfoList.get(i).getFile_url());
                    }
