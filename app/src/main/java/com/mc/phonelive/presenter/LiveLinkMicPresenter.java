package com.mc.phonelive.presenter;
...
import com.mc.phonelive.interfaces.ILiveLinkMicViewHolder;
import com.mc.phonelive.interfaces.LivePushListener;
import com.mc.phonelive.socket.SocketClient;
import com.mc.phonelive.socket.SocketLinkMicUtil;
...
import com.mc.phonelive.views.LiveLinkMicPlayViewHolder;
import com.mc.phonelive.views.LiveLinkMicPushViewHolder;
...
public class LiveLinkMicPresenter implements View.OnClickListener {
    ...
    private void showLinkMicDialog(UserBean u) {
        ...
        sex.setImageResource(IconUtil.getSexIcon(Integer.parseInt(u.getSex())));
