...
import com.mc.phonelive.adapter.CzAdapter;
...
public class ChongZhiListActivity extends AbsActivity {
...
//        DateUtils.getCurrentYear()
    ...
    private void setInfo(String tm) {
        HttpUtil.getChongZhi(1,tm,new HttpCallback() {
            @Override
