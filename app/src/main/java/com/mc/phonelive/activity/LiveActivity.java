...
import com.mc.phonelive.dialog.LiveChatListDialogFragment;
import com.mc.phonelive.dialog.LiveChatRoomDialogFragment;
import com.mc.phonelive.dialog.LiveGuardBuyDialogFragment;
import com.mc.phonelive.dialog.LiveGuardDialogFragment;
import com.mc.phonelive.dialog.LiveInputDialogFragment;
import com.mc.phonelive.dialog.LivePeopleListDialogFragment;
import com.mc.phonelive.dialog.LiveRedPackListDialogFragment;
...
import com.mc.phonelive.socket.SocketMessageListener;
...
import com.mc.phonelive.views.AbsLiveViewHolder;
import com.mc.phonelive.views.LiveAddImpressViewHolder;
import com.mc.phonelive.views.LiveAdminListViewHolder;
...
public abstract class LiveActivity extends AbsActivity implements SocketMessageListener, LiveShareDialogFragment.ActionListener, KeyBoardHeightChangeListener {
    ...
    ArrayList<LiveUserGiftBean> mUserList = new ArrayList<>();
    @Override
    protected void main() {
    ...
    public void showshopWindow(){
        ...
        fragment.show(((LiveActivity) mContext).getSupportFragmentManager(), "ShopShowDialogFragment");
    ...
    public void onChat(LiveChatBean bean) {
        Log.i("ywl",bean.getType()+"bean:"+bean.getContent());
     ...
     * 打开观众列表窗口
     */
    public void openPeopleListWindow() {
        LivePeopleListDialogFragment fragment = new LivePeopleListDialogFragment();
//        if (!mIsAnchor) {
            Bundle bundle = new Bundle();
            bundle.putString(Constants.LIVE_UID, mLiveUid);
            bundle.putParcelableArrayList("userList",mUserList);
            fragment.setArguments(bundle);
//        }
        fragment.show(getSupportFragmentManager(), "LivePeopleListDialogFragment");
    }
    ...
    public void onPeopleEvent(EventBusModel e) {
        if (e.getCode().equals("userlists")){
            ArrayList<LiveUserGiftBean> list = (ArrayList<LiveUserGiftBean>) e.getObject();
