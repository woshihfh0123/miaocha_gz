...
import com.mc.phonelive.fragment.MerchantOrderFragment;
 ...
 * 我的商家订单（我是商家 待我处理）
 */
public class MyMerchantOrderActivity extends AbsActivity implements View.OnClickListener {
...
//    ImageView searchImg;
    private String[] mTitleDataList = {"全部", "发","待发货", "已发货", "已完成"};
...
//                SimplePagerTitleView simplePagerTitleView = new ScaleTransitionPagerTitleView(context);// 文字变化样式
    ...
    public void initViewPagerData() {
        ...
        for (int i = 0; i < mTitleDataList.length; i++) {
            MerchantOrderFragment fragment = (MerchantOrderFragment) MerchantOrderFragment.newInstance();
            fragment.setState(i + "");
    ...
    public void onViewClicked() {
        MyMerchantOrderActivity.this.finish();
    }
