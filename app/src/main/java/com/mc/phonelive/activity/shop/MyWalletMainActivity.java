...
import com.mc.phonelive.fragment.FudouFragment;
import com.mc.phonelive.fragment.LedouFragment;
 ...
 */
public class MyWalletMainActivity extends AbsActivity {
    ...
    private String[] mTitleDataList = {"乐豆", "福豆"};
...
//                SimplePagerTitleView simplePagerTitleView = new ScaleTransitionPagerTitleView(context);// 文字变化样式
    ...
    public void initViewPagerData() {
        ...
        LedouFragment fragment = (LedouFragment) LedouFragment.newInstance();
        fragment.setState(0 + "");
        mFragmentList.add(fragment);

        FudouFragment fragment01 = (FudouFragment) FudouFragment.newInstance();
        fragment01.setState(1 + "");
