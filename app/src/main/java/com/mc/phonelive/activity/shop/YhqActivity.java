...
import com.mc.phonelive.fragment.YhqFragment;
 ...
 * 优惠券--新888888
 */
public class YhqActivity extends AbsActivity implements View.OnClickListener {
    ...
    ImageView searchImg;
    private String[] mTitleDataList = {"全部", "未使用", "已过期"};
    private ViewPager mViewPager;
    private ArrayList<Fragment> mFragmentList;

    @Override
    public int getLayoutId() {
        return R.layout.order_yhq;
    }
...
//                SimplePagerTitleView simplePagerTitleView = new ScaleTransitionPagerTitleView(context);// 文字变化样式
    ...
    public void initViewPagerData() {
        ...
        for (int i = 0; i < mTitleDataList.length; i++) {
            YhqFragment fragment = (YhqFragment) YhqFragment.newInstance();
            fragment.setState(i + "");
