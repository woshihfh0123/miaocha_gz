 ...
 * 小店申请
 */
public class MyShopApplyActivity extends AbsActivity  {

//    private EditText mShopName,mShopcontent;
//    private ImageView mlogoImg,mCardImg01,mCardImg02,mCardImg03;
private ProgressBar mProgressBar;
    ...
    protected int getLayoutId() {
        return R.layout.activity_my_myshop_apply;
    }

    @Override
    protected void main() {
//        setTitle("入驻申请");
//        mShopName =findViewById(R.id.name_eidt);
//        mShopcontent =findViewById(R.id.content_eidt);
//        mlogoImg =findViewById(R.id.logo_img);
//        mCardImg01 =findViewById(R.id.card1_img);
//        mCardImg02 =findViewById(R.id.card2_img);
//        mCardImg03 =findViewById(R.id.card3_img);
