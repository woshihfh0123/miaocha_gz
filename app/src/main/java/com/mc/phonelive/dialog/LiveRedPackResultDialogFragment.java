...
import com.mc.phonelive.adapter.RedPackResultAdapter;
import com.mc.phonelive.bean.RedPackBean;
import com.mc.phonelive.bean.RedPackResultBean;
...
public class LiveRedPackResultDialogFragment extends AbsDialogFragment {
    ...
    protected void setWindowAttributes(Window window) {
        ...
        params.width = DpUtil.dp2px(355);
        params.height = DpUtil.dp2px(510);
