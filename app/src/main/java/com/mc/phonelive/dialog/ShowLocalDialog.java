 ...
 *
 */
public class ShowLocalDialog extends Dialog implements OnClickListener {
	...
	public ShowLocalDialog(Context context, String title, String msg) {
		super(context);
	...
	public ShowLocalDialog(Context context, int theme) {
		super(context, theme);
		factory = LayoutInflater.from(context);
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setContentView(factory.inflate(R.layout.show_location_dialog, null));
