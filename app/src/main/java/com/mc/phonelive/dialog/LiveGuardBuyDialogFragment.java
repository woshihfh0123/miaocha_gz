...
import com.mc.phonelive.adapter.GuardRightAdapter;
import com.mc.phonelive.bean.GuardBuyBean;
import com.mc.phonelive.bean.GuardRightBean;
...
public class LiveGuardBuyDialogFragment extends AbsDialogFragment implements View.OnClickListener {
    ...
    private ImageView tip_img01,tip_img02,tip_img03;
    private FrameLayout  price_layout01,price_layout02,price_layout03;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        title_layout = mRootView.findViewById(R.id.title_layout);
        mCoin = (TextView) mRootView.findViewById(R.id.coin);
        mBtnBuy = mRootView.findViewById(R.id.btn_buy);
        price_layout01 = mRootView.findViewById(R.id.price_layout01);
        price_layout02 = mRootView.findViewById(R.id.price_layout02);
        price_layout03 = mRootView.findViewById(R.id.price_layout03);
        tip_img01 = mRootView.findViewById(R.id.tip_img01);
        tip_img02 = mRootView.findViewById(R.id.tip_img02);
        tip_img03 = mRootView.findViewById(R.id.tip_img03);
        ...
        price_layout03.setOnClickListener(this);
        price_layout02.setOnClickListener(this);
        price_layout01.setOnClickListener(this);
                ...
                if (code == 0 && info.length > 0) {
                    ...
                    for (int i = 0, length = mPrices.length; i < length; i++) {
                        if (i < buyListSize) {
                            ...
                            mPrices[i].setText(String.valueOf(buyBean.getCoin())+"茶籽");
                        }
                    }
                    refreshList(0);
                } else {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btn_1:
            case R.id.price_layout01:
                title_layout.setBackgroundResource(R.mipmap.shouhu_timer);
                mPrices[0].setTextColor(getResources().getColor(R.color.white));
                mPrices[1].setTextColor(getResources().getColor(R.color.gray3));
                mPrices[2].setTextColor(getResources().getColor(R.color.gray3));
                tip_img01.setVisibility(View.VISIBLE);
                tip_img02.setVisibility(View.INVISIBLE);
                tip_img03.setVisibility(View.INVISIBLE);
                mRadioBtns[0].setChecked(true);
                refreshList(0);
                break;
            case R.id.btn_2:
            case R.id.price_layout02:
                title_layout.setBackgroundResource(R.mipmap.shouhu_timer);
                mPrices[0].setTextColor(getResources().getColor(R.color.gray3));
                mPrices[1].setTextColor(getResources().getColor(R.color.white));
                mPrices[2].setTextColor(getResources().getColor(R.color.gray3));
                tip_img01.setVisibility(View.INVISIBLE);
                tip_img02.setVisibility(View.VISIBLE);
                tip_img03.setVisibility(View.INVISIBLE);
                mRadioBtns[1].setChecked(true);
                refreshList(1);
                break;
            case R.id.btn_3:
            case R.id.price_layout03:
                title_layout.setBackgroundResource(R.mipmap.shouhu_timer03);
                mPrices[0].setTextColor(getResources().getColor(R.color.gray3));
                mPrices[1].setTextColor(getResources().getColor(R.color.gray3));
                mPrices[2].setTextColor(getResources().getColor(R.color.white));
                tip_img01.setVisibility(View.INVISIBLE);
                tip_img02.setVisibility(View.INVISIBLE);
                tip_img03.setVisibility(View.VISIBLE);
                mRadioBtns[2].setChecked(true);
                refreshList(2);
                break;
            case R.id.btn_buy:
                clickBuyGuard();
