 ...
 *
 */
public class RedpackDialog extends Dialog implements OnClickListener {
	...
	public RedpackDialog(Context context, String title, String msg) {
		super(context);
	...
	public RedpackDialog(Context context, int theme) {
		super(context, theme);
		factory = LayoutInflater.from(context);
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setContentView(factory.inflate(R.layout.redpack_dialog, null));
