...
public class VideoShareDialogFragmentHome extends AbsDialogFragment implements OnItemClickListener<MobBean> {
    ...
    public void onItemClick(MobBean bean, int position) {
        ...
        switch (bean.getType()) {
            ...
            default:
                try{
                    ((MainActivity) mContext).shareVideoPage(bean.getType(), mVideoBean);
                }catch (Exception e){
