...
//    public static final int errorSoWhite = R.color.cp_color_gray;
    public static final int placeholderSoWhite = R.drawable.default_img;
    public static final int errorSoWhite = R.drawable.default_img;
    ...
    public static void loadImageNpd(Context context, String url, ImageView imageView) {
        if(Utils.isNotEmpty(url)&&url.contains("http")){
...
//            Glide.with(context).load(url).apply(options).into(imageView);
    ...
    public static void loadImage(Context context, Drawable url, ImageView imageView) {
        if(Utils.isNotEmpty(url)){
...
//            Glide.with(context).load(url).apply(options).into(imageView);
    ...
    public static void loadImage(Context context, int uri, ImageView imageView,int width, int height) {
        if(Utils.isNotEmpty(uri)){
            RequestOptions options = new RequestOptions()
                    .centerCrop()
                    .placeholder(placeholderSoWhite)
