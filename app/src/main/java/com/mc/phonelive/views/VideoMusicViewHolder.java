...
import com.mc.phonelive.adapter.MusicClassAdapter;
import com.mc.phonelive.bean.MusicBean;
import com.mc.phonelive.bean.MusicClassBean;
import com.mc.phonelive.dialog.VideoMusicClassDialog;
...
import com.mc.phonelive.utils.MusicMediaPlayerUtil;
...
public class VideoMusicViewHolder extends AbsViewHolder implements View.OnClickListener, OnItemClickListener<MusicClassBean>, VideoMusicActionListener {
    ...
    public void onPlayMusic(final MusicAdapter adapter, final MusicBean bean, final int position) {
        Log.e("sssssssssssssssssss","sssss");
