...
import com.mc.phonelive.im.ChatImListAdapter;
...
public class ChatListViewHolderAct extends AbsViewHolder implements View.OnClickListener, ChatImListAdapter.ActionListener {
    ...
    private ChatImListAdapter mAdapter;
    ...
    public ChatListViewHolderAct(Context context, ViewGroup parentView, int type) {
    ...
    protected int getLayoutId() {
        return R.layout.view_chat_list_act;
    }
    ...
    public void init() {
        ...
        mAdapter = new ChatImListAdapter(mContext);
