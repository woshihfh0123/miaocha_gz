...
public class VideoDt extends AbsViewHolder implements OnItemClickListener<VideoBean> {
    ...
    public VideoDt(Context context, ViewGroup parentView, String toUid) {
...
//        }
        ...
        mRefreshView.setDataHelper(new RefreshView.DataHelper<VideoBean>() {
            ...
            public RefreshAdapter<VideoBean> getAdapter() {
                if (mAdapter == null) {
                    ...
                    mAdapter.setOnItemClickListener(VideoDt.this);
                }
                return mAdapter;
            }
        ...
        mLifeCycleListener = new LifeCycleAdapter() {
            ...
            public void onCreate() {
                EventBus.getDefault().register(VideoDt.this);
            }

            @Override
            public void onDestroy() {
                HttpUtil.cancel(HttpConsts.GET_HOME_VIDEO);
                EventBus.getDefault().unregister(VideoDt.this);
            }
        };
        loadData();
