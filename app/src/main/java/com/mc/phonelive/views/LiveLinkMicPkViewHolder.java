...
import com.mc.phonelive.custom.FrameImageView;
import com.mc.phonelive.custom.PkProgressBar;
import com.mc.phonelive.custom.ProgressTextView2;
...
public class LiveLinkMicPkViewHolder extends AbsViewHolder {
    ...
    private CardView mPkProgressBarCard;
...
//        mRightString = WordUtil.getString(R.string.live_link_mic_pk_2);
        ...
        mPkProgressBarCard = (CardView) findViewById(R.id.progressbarcard);
        ...
        mAnimator1.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                if (mPkProgressBarCard != null && mPkProgressBarCard.getVisibility() != View.VISIBLE) {
                    mPkProgressBarCard.setVisibility(View.VISIBLE);
                }
                if (mLeft != null) {
