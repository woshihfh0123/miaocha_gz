...
public class AskRightViewHolder extends AbsMainChildTopViewHolder {
    ...
    private int page=1;
    public AskRightViewHolder(Context context, ViewGroup parentView) {
        super(context, parentView);
    }

    @Override
    protected int getLayoutId() {
        return R.layout.activity_right_wy;
    }
    ...
    private void getList() {//String p,String type,String catid
        HttpUtil.getWyGz(page+"",new HttpCallback() {
            @Override
