...
public class VideoHomeScrollViewHolder extends AbsViewHolder implements
    ...
    public VideoHomeScrollViewHolder(Context context, ViewGroup parentView) {
    ...
    public void init() {
        ...
        mVideoDataHelper = new VideoScrollDataHelper() {
            ...
            public void loadData(int p, HttpCallback callback) {
                HttpUtil.getHomeVideoList(p, mTypeId, mRefreshCallback);
            }
        };
                ...
                if (code == 0) {
                    ...
                    if (!DataSafeUtils.isEmpty(infolist.get(0).getVideolist())) {
                        ...
                        if (mVideoScrollAdapter == null) {
                            ...
                            mVideoScrollAdapter.setActionListener(VideoHomeScrollViewHolder.this);
...
//                        ToastUtil.show(R.string.video_no_more_video);
    ...
    private void initHttpData() {
        if (mPages > 1) {
            HttpUtil.getHomeVideoList(mPages, mTypeId, mLoadMoreCallback);
        } else {
            Log.v("tags", "数据加载...");
            HttpUtil.getHomeVideoList(1, mTypeId, mRefreshCallback);
        }
    }
    ...
    public void onVideoTypeEvent(EventBusModel e) {
        ...
        if (code.equals("video_type")) {
            ...
            if (mIndex == 1) {
                ...
                if (mVideoPlayViewHolder != null) {
                    mVideoPlayViewHolder.resumePlay();
                    if (!mVideoPlayViewHolder.mClickPaused){
                    }
                }
            }
