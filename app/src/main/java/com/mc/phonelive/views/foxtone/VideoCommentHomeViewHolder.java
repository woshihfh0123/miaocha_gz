...
public class VideoCommentHomeViewHolder extends AbsViewHolder implements View.OnClickListener, OnItemClickListener<VideoCommentBean> {
    ...
    public VideoCommentHomeViewHolder(Context context, ViewGroup parentView) {
        ...
        mRefreshView.setDataHelper(new RefreshView.DataHelper<VideoCommentBean>() {
            ...
            public RefreshAdapter<VideoCommentBean> getAdapter() {
                if (mVideoCommentAdapter == null) {
                    ...
                    mVideoCommentAdapter.setOnItemClickListener(VideoCommentHomeViewHolder.this);
                }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_close:
                ...
                break;
            case R.id.input:
                ((MainActivity) mContext).openCommentInputWindow(false, mVideoBean, null);
                break;
            case R.id.btn_face:
                ((MainActivity) mContext).openCommentInputWindow(true, mVideoBean, null);
                break;
        }
    }
    ...
    public void onItemClick(VideoCommentBean bean, int position) {
        ((MainActivity) mContext).openCommentInputWindow(false, mVideoBean, bean);
    }
