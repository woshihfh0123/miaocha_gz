...
public class CircleProgressbar extends View {
     ...
     *  
     */
    private int[] colorArray = new int[]{Color.parseColor("#FF4443"),
            Color.parseColor("#FF4443"), Color.parseColor("#FF4443")};
...
//一般只是希望在View发生改变时对UI进行重绘。invalidate()方法系统会自动调用 View的onDraw()方法。
                    invalidate();
                    if (maxValue == currentValue && CircleProgressbar.this.listener != null) {
                        CircleProgressbar.this.listener.onFinish();
                    }
                }
            });
