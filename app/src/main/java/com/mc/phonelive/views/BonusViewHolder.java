...
import com.mc.phonelive.custom.BonusItemView;
...
public class BonusViewHolder extends AbsViewHolder implements View.OnClickListener {
    ...
    public void init() {
        ...
        mItemTv = new TextView[6];
        mItemTv[0] = (TextView) findViewById(R.id.tv_day_1);
        mItemTv[1] = (TextView) findViewById(R.id.tv_day_2);
        mItemTv[2] = (TextView) findViewById(R.id.tv_day_3);
        mItemTv[3] = (TextView) findViewById(R.id.tv_day_4);
        mItemTv[4] = (TextView) findViewById(R.id.tv_day_5);
        mItemTv[5] = (TextView) findViewById(R.id.tv_day_6);
    ...
    public void setData(List<BonusBean> list, int day, String continueDay) {
        ...
        for (int i = 0, length = mItemViews.length; i < length; i++) {
            if (i <= mDay - 1) {
                ...
                mItemTv[i].setBackgroundResource(R.drawable.bg_bouns_tv);
                mItemTv[i].setTextColor(mContext.getResources().getColor(R.color.white));
            } else {
                break;
            }
        }
