...
public class VideoHomeFollowScrollViewHolder extends AbsViewHolder implements
    ...
    public VideoHomeFollowScrollViewHolder(Context context, ViewGroup parentView) {
    ...
    public void init() {
        ...
        mVideoDataHelper = new VideoScrollDataHelper() {
            ...
            public void loadData(int p, HttpCallback callback) {
                HttpUtil.getvideoFollow(p,  mRefreshCallback);
            }
        };
...
//        hAdapter.setNewData(nlist);
    ...
    private void initHttpData() {
        if (mPages > 1) {
            HttpUtil.getvideoFollow(mPages,  mLoadMoreCallback);
        } else {
            Log.v("tags", "数据加载...");
            HttpUtil.getvideoFollow(1,  mRefreshCallback);
        }
    }
