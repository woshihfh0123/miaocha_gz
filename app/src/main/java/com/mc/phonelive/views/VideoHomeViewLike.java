...
public class VideoHomeViewLike extends AbsViewHolder implements OnItemClickListener<VideoBean> {
    ...
    public VideoHomeViewLike(Context context, ViewGroup parentView, String toUid) {
...
//        }
        ...
        mRefreshView.setDataHelper(new RefreshView.DataHelper<VideoBean>() {
            ...
            public RefreshAdapter<VideoBean> getAdapter() {
                if (mAdapter == null) {
                    ...
                    mAdapter.setOnItemClickListener(VideoHomeViewLike.this);
                }
                return mAdapter;
            }
        ...
        mLifeCycleListener = new LifeCycleAdapter() {
            ...
            public void onCreate() {
                EventBus.getDefault().register(VideoHomeViewLike.this);
            }

            @Override
            public void onDestroy() {
                HttpUtil.cancel(HttpConsts.GET_HOME_VIDEO);
                EventBus.getDefault().unregister(VideoHomeViewLike.this);
            }
        };
        loadData();
