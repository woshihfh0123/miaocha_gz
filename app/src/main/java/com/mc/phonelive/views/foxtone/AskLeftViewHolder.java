...
public class AskLeftViewHolder extends AbsMainChildTopViewHolder {
    ...
    private int page=1;
    public AskLeftViewHolder(Context context, ViewGroup parentView) {
        super(context, parentView);
    }

    @Override
    protected int getLayoutId() {
        return R.layout.activity_left_wy;
    }
    ...
    private void getList() {//String p,String type,String catid
        HttpUtil.getWy(page+"","","",new HttpCallback() {
            @Override
