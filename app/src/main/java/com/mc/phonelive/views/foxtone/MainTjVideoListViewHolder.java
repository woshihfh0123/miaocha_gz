...
public class MainTjVideoListViewHolder extends AbsMainChildTopViewHolder {
    ...
    public MainTjVideoListViewHolder(Context context, ViewGroup parentView) {
    ...
    public void init() {
        ...
        mVideoScrollViewHolder = new VideoHomeScrollViewHolderTj(mContext, (ViewGroup) findViewById(R.id.container));
