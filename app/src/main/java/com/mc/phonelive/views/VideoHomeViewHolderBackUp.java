...
public class VideoHomeViewHolderBackUp extends AbsViewHolder implements OnItemClickListener<VideoBean> {
    ...
    public VideoHomeViewHolderBackUp(Context context, ViewGroup parentView, String toUid) {
        ...
        mRefreshView.setDataHelper(new RefreshView.DataHelper<VideoBean>() {
            ...
            public RefreshAdapter<VideoBean> getAdapter() {
                if (mAdapter == null) {
                    ...
                    mAdapter.setOnItemClickListener(VideoHomeViewHolderBackUp.this);
                }
                return mAdapter;
            }
...
//                EventBus.getDefault().register(VideoHomeViewHolderBackUp.this);
//            }
//
//            @Override
//            public void onDestroy() {
//                HttpUtil.cancel(HttpConsts.GET_HOME_VIDEO);
//                EventBus.getDefault().unregister(VideoHomeViewHolderBackUp.this);
//            }
//        };
        loadData("1");
...
//        }
    ...
    public void loadData(String flags) {
        Log.e("8","ffffffffffffffffffffffffffff"+flags);
        if (mRefreshView != null) {
