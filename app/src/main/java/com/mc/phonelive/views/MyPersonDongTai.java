...
import com.mc.phonelive.adapter.MyPSVideoHomeAdapter;
...
public class MyPersonDongTai extends AbsViewHolder implements OnItemClickListener<VideoBean> {

    private RefreshView mRefreshView;
    private MyPSVideoHomeAdapter mAdapter;
    ...
    public MyPersonDongTai(Context context, ViewGroup parentView, String toUid) {
...
//        EventBusUtil.register(mContext);
        ...
        mRefreshView.setDataHelper(new RefreshView.DataHelper<VideoBean>() {
            ...
            public RefreshAdapter<VideoBean> getAdapter() {
                if (mAdapter == null) {
                    mAdapter = new MyPSVideoHomeAdapter(mContext);
                    mAdapter.setOnItemClickListener(MyPersonDongTai.this);
                }
                return mAdapter;
            }
