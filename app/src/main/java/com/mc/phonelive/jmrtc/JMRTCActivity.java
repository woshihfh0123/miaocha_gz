//package com.zhiboshow.phonelive.jmrtc;
//
...
//import com.zhiboshow.phonelive.activity.AbsActivity;
//import com.zhiboshow.phonelive.bean.UserBean;
//
...
//
//public class JMRTCActivity extends AbsActivity implements View.OnClickListener {
//
...
//
//        String mToUid =this.getIntent().getStringExtra("touid");
//        mUserBean =this.getIntent().getParcelableExtra("user");
//        etInvitedUsername.setText(mToUid);etInvitedUsername.setVisibility(View.GONE);
//    }
//
//    @Override
...
//        myinfo.setNickname(mUserBean.getUserNiceName());
//        Map<String,String> map = new HashMap<>();
//        map.put("avator",mUserBean.getAvatar());
//        map.put("uid",mUserBean.getId());
