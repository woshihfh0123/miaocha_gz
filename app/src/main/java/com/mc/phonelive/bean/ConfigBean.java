...
public class ConfigBean {
    ...
    private List<VideoClassBean> vodeoclass;//视频分类
    ...
    private String vote_rate;//音豆专音票比例
    ...
    public List<VideoClassBean> getVodeoclass() {
        return vodeoclass;
    }

    public void setVodeoclass(List<VideoClassBean> vodeoclass) {
        this.vodeoclass = vodeoclass;
    }
