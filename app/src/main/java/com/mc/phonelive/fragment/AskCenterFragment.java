 ...
 * 发现好友
 */
public class AskCenterFragment extends BaseFragment implements TaskListAdapter.TaskListener {
    View layoutView;
    ...
    public static AskCenterFragment newInstance() {
        AskCenterFragment fragment = new AskCenterFragment();
        return fragment;
    }
