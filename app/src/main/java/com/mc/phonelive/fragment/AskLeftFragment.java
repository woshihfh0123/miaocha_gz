...
import com.mc.phonelive.adapter.WyLeftAdapter;
 ...
 * 发现好友
 */
public class AskLeftFragment extends BaseFragment implements TaskListAdapter.TaskListener {
    View layoutView;
    private com.scwang.smartrefresh.layout.SmartRefreshLayout mRefreshLayout;
    private RecyclerView mRv;
    private WyLeftAdapter mAdapter;
    private TextView mTv_noinfo;
    private LinearLayout ll_txl,ll_sys;
    public static AskLeftFragment newInstance() {
        AskLeftFragment fragment = new AskLeftFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        layoutView = inflater.inflate(R.layout.ask_fragment_all, container, false);
        return layoutView;
    }
