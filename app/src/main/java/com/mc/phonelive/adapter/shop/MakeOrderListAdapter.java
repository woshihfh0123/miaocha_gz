 ...
 */
public class MakeOrderListAdapter extends BaseQuickAdapter<PayOrderBean, BaseViewHolder> {
    BaseQuickAdapter<PayOrderBean.GoodsBean,BaseViewHolder> mGoodsAdapter;
    public MakeOrderListAdapter(int layoutResId, @Nullable List<PayOrderBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, PayOrderBean item) {
...
//        }
    ...
    public void getGoodsAdapter(RecyclerView foodcart_recyclerview, List<PayOrderBean.GoodsBean> list){
        mGoodsAdapter = new BaseQuickAdapter<PayOrderBean.GoodsBean, BaseViewHolder>(R.layout.order_food_item_item_layout,list) {
            @Override
            protected void convert(BaseViewHolder helper, PayOrderBean.GoodsBean item) {
    ...
    private void getFoodRemark(EditText mFoodRemark, final PayOrderBean food) {
