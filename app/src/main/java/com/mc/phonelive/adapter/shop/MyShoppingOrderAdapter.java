 ...
 */
public class MyShoppingOrderAdapter extends BaseQuickAdapter<OrderListVo.InfoBean, BaseViewHolder> {
    private Context mContext;
    private String mType;
    BaseQuickAdapter<OrderListVo.InfoBean.GoodsListBean, BaseViewHolder> mFoodListAdapter;

    public MyShoppingOrderAdapter(Context context, int layoutResId, @Nullable List<OrderListVo.InfoBean> data, String type) {
