...
public class VideoShareAdapter1 extends RecyclerView.Adapter<VideoShareAdapter1.Vh> {
    ...
    public VideoShareAdapter1(Context context, List<MobBean> list) {
        mList = list;
    ...
    public Vh onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new Vh(mInflater.inflate(R.layout.item_live_share1, parent, false));
    }
