...
public class VideoHomeScrollAdapter extends RecyclerView.Adapter<VideoHomeScrollAdapter.Vh> implements ItemSlideHelper.Callback {
    ...
    public VideoHomeScrollAdapter(Context context, List<VideoBean> list, int curPosition) {
        mContext = context;
        mList = list;
