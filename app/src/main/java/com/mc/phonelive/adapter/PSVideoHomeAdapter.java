...
public class PSVideoHomeAdapter extends RefreshAdapter<VideoBean> {

    private View.OnClickListener mOnClickListener;

    public PSVideoHomeAdapter(Context context) {
        super(context);
...
//            video_cardview.setLayoutParams(params);
        ...
        void setData(VideoBean bean, int position) {
            ...
            ll_pl.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ((UserHomeActivity) mContext).openCommentWindow(bean);
                }
            });
