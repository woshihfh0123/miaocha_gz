...
public class Constants {
    ...
    public static final String DIAMONDS = "茶籽";//礼物价值表示-------钻石9999999
    public static final String VOTES = "茶票";
    ...
    public static final int SETTING_TRANSCATION_PWD = 19;
    ...
    public static final boolean TENXUN_GOOGLE = false;//如果是false就调用腾讯地图，   如果是true就调用Google地图

    public static final int COOUNTDOWMTIME=60;//观看视频倒计时设置
