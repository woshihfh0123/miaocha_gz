...
public class ShopViewPagerIndicator extends LinearLayout implements ViewPager.OnPageChangeListener {
    ...
    public ShopViewPagerIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
...
//        Drawable[] nav_up={getResources().getDrawable(R.mipmap.shop_title_fir),getResources().getDrawable(R.mipmap.shop_title_fir_zk)};
        for (int i = 0; i < mTitles.length; i++) {
            final TextView textView = new TextView(mContext);
//            nav_up[i].setBounds(0, 0, nav_up[i].getMinimumWidth(), nav_up[i].getMinimumHeight());
//            textView.setCompoundDrawables(nav_up[i],null, null,  null);
