...
public class MyTextViewPs extends TextView {
    ...
    public MyTextViewPs(Context context) {
        this(context, null);
    }

    public MyTextViewPs(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyTextViewPs(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
