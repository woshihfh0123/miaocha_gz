...
import com.mc.phonelive.activity.LoginInvalidActivity;
...
public abstract class HttpAllCallback extends AbsCallback<JsonBean> {
            ...
            if (200 == bean.getRet()) {
                ...
                if (data != null) {
                    if (700 == data.getCode()) {
                        ...
                        onSuccess(data.getCode(), data.getMsg(), bean.getData());
                    }
                } else {
