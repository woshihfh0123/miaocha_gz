...
public class ChatImListAdapter extends RecyclerView.Adapter implements ItemSlideHelper.Callback {
    ...
    public ChatImListAdapter(Context context) {
        mContext = context;
        mList = new ArrayList<>();
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == HEAD) {
            return new Vh(mInflater.inflate(R.layout.item_im_list_head1, parent, false));
        } else if (viewType == ANCHOR) {
            return new AnchorVh(mInflater.inflate(R.layout.item_im_list_anchor1, parent, false));
        }
        return new Vh(mInflater.inflate(R.layout.item_im_list1, parent, false));
    }
