package com.mc.phonelive.tecent.videoeditor;
...
import com.mc.phonelive.tecent.videopublish.TCVideoPublisherActivity;
...
public class TCVideoEditerActivity extends FragmentActivity implements View.OnClickListener {
    ...
    private void startPreviewActivity(UGCKitResult ugcKitResult) {
        ...
        if (ugcKitResult.isPublish) {
            ...
            VideoPublishActivity.forward(this, ugcKitResult.outputPath, Constants.VIDEO_SAVE_PUB);
            finish();
