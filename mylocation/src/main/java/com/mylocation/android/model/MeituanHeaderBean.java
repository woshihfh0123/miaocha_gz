...
public class MeituanHeaderBean extends BaseIndexPinyinBean {
    private List<MeiTuanBean> cityList;
    ...
    public MeituanHeaderBean(List<MeiTuanBean> cityList, String suspensionTag, String indexBarTag) {
        this.cityList = cityList;
        this.suspensionTag = suspensionTag;
        this.setBaseIndexTag(indexBarTag);
    }

    public List<MeiTuanBean> getCityList() {
        return cityList;
    }

    public MeituanHeaderBean setCityList(List<MeiTuanBean> cityList) {
        this.cityList = cityList;
        return this;
    }
